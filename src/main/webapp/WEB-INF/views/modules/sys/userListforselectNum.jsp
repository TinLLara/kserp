...
<head>
	...
	<script type="text/javascript">
		...
		function doSelect(loginName,name,num){
			window.opener.setNameNumber('${clickObjectName}','${clickObjectId}','${setObjectName}',loginName,name,num);
			window.close();
		};
	</script>
</head>
		...
		<c:forEach items="${page.list}" var="user">
			<tr>
				...
				<shiro:hasPermission name="sys:user:edit"><td>
					<a  onclick="doSelect('${user.loginName}','${user.name}','${user.mobile}');" style="cursor: pointer;">选取</a>
