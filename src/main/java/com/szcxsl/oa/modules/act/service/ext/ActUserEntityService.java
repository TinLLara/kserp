 ...
 */
package com.szcxsl.oa.modules.act.service.ext;
...
import com.szcxsl.oa.modules.act.utils.ActUtils;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new com.szcxsl.oa.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new com.szcxsl.oa.modules.sys.entity.User(null, userId)))){
