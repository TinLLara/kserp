...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/oabustrip/oaBusitrip/listforcheck">出差申请列表</a></li>
		<%-- <shiro:hasPermission name="oabustrip:oaBusitrip:edit"><li><a href="${ctx}/oabustrip/oaBusitrip/formforcheck">出差申请添加</a></li></shiro:hasPermission> --%>
	</ul>
	<form:form id="searchForm" modelAttribute="oaBusitrip" action="${ctx}/oabustrip/oaBusitrip/listforcheck" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="oaBusitrip">
			<tr>
				<td><a href="${ctx}/oabustrip/oaBusitrip/formforcheck?tag=view&busitripid=${oaBusitrip.busitripid}">
					${oaBusitrip.tripnum}
				</a></td>
				<td>
				...
				<shiro:hasPermission name="oabustrip:oaBusitrip:edit"><td>
					<a href="${ctx}/oabustrip/oaBusitrip/formforcheck?tag=check&busitripid=${oaBusitrip.busitripid}" onclick="if('${oaBusitrip.nextnode}'=='refuse'||'${oaBusitrip.nextnode}'=='authed'){alert('温馨提示：该记录已审批，不能执行此操作！');return false;}">审批</a>
