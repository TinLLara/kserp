...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/oayzsq/oaYinzsq/formforcheck">印章申请列表</a></li>
		<%-- <shiro:hasPermission name="oayzsq:oaYinzsq:edit"><li><a href="${ctx}/oayzsq/oaYinzsq/form">印章申请添加</a></li></shiro:hasPermission> --%>
	</ul>
	<form:form id="searchForm" modelAttribute="oaYinzsq" action="${ctx}/oayzsq/oaYinzsq/listforcheck" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="oaYinzsq">
			<tr>
				<td><a href="${ctx}/oayzsq/oaYinzsq/formforcheck?tag=view&id=${oaYinzsq.id}">
					${oaYinzsq.appname}
				</a></td>
				<td>
					${oaYinzsq.appdate}
				...
				<shiro:hasPermission name="oayzsq:oaYinzsq:edit"><td>
					<a href="${ctx}/oayzsq/oaYinzsq/formforcheck?tag=check&id=${oaYinzsq.id}" onclick="if('${oaYinzsq.nextop}'=='refuse'||'${oaYinzsq.nextop}'=='authed'){alert('温馨提示：该记录已审批，不能执行此操作！');return false;}">审批</a>
