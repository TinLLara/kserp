...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/testuser/testData/">测试列表</a></li>
		<li class="active"><a href="${ctx}/testuser/testData/form?id=${testData.id}">测试<shiro:hasPermission name="testuser:testData:edit">${not empty testData.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="testuser:testData:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="testData" action="${ctx}/testuser/testData/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="testuser:testData:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="提 交"/>&nbsp;</shiro:hasPermission>
