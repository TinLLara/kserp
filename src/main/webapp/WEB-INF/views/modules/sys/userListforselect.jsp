...
<head>
	...
	<script type="text/javascript">
		...
		function doSelect(loginName,name){
			window.opener.setNextOper('${clickObjectName}','${clickObjectId}',loginName,name);
			window.close();
		};
	</script>
</head>
		...
		<c:forEach items="${page.list}" var="user">
			<tr>
				...
				<shiro:hasPermission name="sys:user:edit"><td>
					<a  onclick="doSelect('${user.loginName}','${user.name}');" style="cursor: pointer;">选取</a>
