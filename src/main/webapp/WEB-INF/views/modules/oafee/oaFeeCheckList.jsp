...
<body>
	...
	<form:form id="searchForm" modelAttribute="oaFee" action="${ctx}/oafee/oaFee/listforcheck" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="oaFee">
			<tr>
				<td><a href="${ctx}/oafee/oaFee/formforcheck?tag=view&feeid=${oaFee.feeid}&feecat=${feecat}">
					${oaFee.applyperson}
				</a></td>
				<td>
				...
				<shiro:hasPermission name="oafee:oaFee:edit"><td>
					<a href="${ctx}/oafee/oaFee/formforcheck?tag=check&feeid=${oaFee.feeid}&feecat=${feecat}" onclick="if('${oaFee.state}'=='refuse'||'${oaFee.state}'=='authed'){alert('温馨提示：该记录已审批，不能执行此操作！');return false;}">审批</a>
