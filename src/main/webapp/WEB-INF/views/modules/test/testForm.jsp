...
<body>
	...
	<form:form id="inputForm" modelAttribute="test" action="${ctx}/test/test/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				日期格式：<fmt:formatDate value="${test.createDate}" type="both" pattern="yyyy-MM-dd"/>
				<input id="createDate" name="createDate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate"
					value="<fmt:formatDate value="${test.createDate}" pattern="yyyy-MM-dd"/>"
		...
		<div class="form-actions">
			<shiro:hasPermission name="test:test:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="提 交"/>&nbsp;</shiro:hasPermission>
