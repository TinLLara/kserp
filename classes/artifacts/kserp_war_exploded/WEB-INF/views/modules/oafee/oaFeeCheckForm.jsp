...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/oafee/oaFee/formforcheck?feeid=${oaFee.feeid}">费用<shiro:hasPermission name="oafee:oaFee:edit">${not empty oaFee.feeid?'审批':'审批'}</shiro:hasPermission><shiro:lacksPermission name="oafee:oaFee:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
		  ...
		  <caption align="center"><h3>差旅费用报销</h3></caption>
			...
			<tr>
				...
				<td class='content_body'>
					...
					<input type="text" id="proname" name="proname" style="width:90px;" readonly="readonly" value="${oaFee.projectid}" /></td>
				...
				<td  class='content_body' colspan="6">
					<textarea id="remarks"  maxlength="1000" class="ccsycss"></textarea>
				</td>
				</tr>
				</table>
