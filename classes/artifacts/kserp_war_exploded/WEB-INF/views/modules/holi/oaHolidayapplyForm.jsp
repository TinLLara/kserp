...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/holi/oaHolidayapply/form?happlyid=${oaHolidayapply.happlyid}">请休假申请<shiro:hasPermission name="holi:oaHolidayapply:edit">${not empty oaHolidayapply.happlyid?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="holi:oaHolidayapply:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="oaHolidayapply" action="${ctx}/holi/oaHolidayapply/save?submit=${not empty oaHolidayapply.happlyid?'update':'insert'}" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<c:choose>
			<c:when test="${not empty oaHolidayapply.happlyid}">
				<div class="control-group">
					...
					<div class="controls">
						<form:input path="staffnum" htmlEscape="false" maxlength="32" class="input-medium"/>
					</div>
				</div>
		</c:when>
			<c:otherwise>
				<div class="control-group">
					<label class="control-label">员工编号：</label>
					<div class="controls">
						<input type="text" value="<%=gnumber %>" name="staffnum" id="staffnum"  class="input-medium"/>
					</div>
				</div>
			</c:otherwise>
		</c:choose>
		...
		<c:choose>
			<c:when test="${not empty oaHolidayapply.happlyid}">
				<div class="control-group">
					...
					<div class="controls">
						<form:input path="staffphone" htmlEscape="false" maxlength="16" class="input-medium "/>
					</div>
				</div>
			</c:when>
			<c:otherwise>
				<div class="control-group">
					<label class="control-label">联系电话：</label>
					<div class="controls">
						<input type="text" value="<%=gtel %>" name="staffphone" id="staffphone"  class="input-medium"/>
					</div>
				</div>
			</c:otherwise>
		</c:choose>
		...
		<c:choose>
			<c:when test="${not empty oaHolidayapply.happlyid}">
				<div class="control-group">
					...
					<div class="controls">
						<form:input path="stafftel" htmlEscape="false" maxlength="64" class="input-xlarge "/>
					</div>
				</div>
			</c:when>
			<c:otherwise>
				<div class="control-group">
					<label class="control-label">邮箱地址：</label>
					<div class="controls">
						<input type="text" value="<%=gemail %>" name="stafftel" id="stafftel"  class="input-xlarge"/>
					</div>
				</div>
			</c:otherwise>
		</c:choose>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="reason" onclick="countDays();" htmlEscape="false" maxlength="2000" class="input-xlarge "/>
			</div>
		</div> --%>
		...
		<table  border="0" cellpadding="5" style="align:center;text-align:left;width:80%;" class="content_table">
		  <caption align="center"><h3>请休假申请</h3></caption>
			...
			<c:choose>
				<c:when test="${not empty oaHolidayapply.happlyid}">
					<input type="text" id="nextnoder" name="nextnoder"  readonly="readonly" style="width:120px;background:#F9F9F9;border:0px;color:red;" />
